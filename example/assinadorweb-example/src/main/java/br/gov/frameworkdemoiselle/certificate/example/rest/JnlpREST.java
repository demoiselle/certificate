...
public class JnlpREST {
	...
	private String generate(String identificador, String servico) {
		...
		sb.append("</security>\n");
		sb.append("<resources>\n");
		sb.append("<jar href=\"assinadorweb-desktop-1.2.6.jar\" main=\"true\"/>\n");
		sb.append("<jar href=\"demoiselle-certificate-core-1.2.6.jar\"/>\n");
		sb.append("<jar href=\"demoiselle-certificate-signer-1.2.6.jar\"/>\n");
		sb.append("<jar href=\"demoiselle-certificate-criptography-1.2.6.jar\"/>\n");
		sb.append("<jar href=\"demoiselle-certificate-ca-icpbrasil-1.2.6.jar\"/>\n");
		sb.append("<jar href=\"demoiselle-certificate-ca-icpbrasil-homologacao-1.2.6.jar\"/>\n");
		sb.append("<jar href=\"demoiselle-certificate-desktop-1.2.6.jar\"/>\n");

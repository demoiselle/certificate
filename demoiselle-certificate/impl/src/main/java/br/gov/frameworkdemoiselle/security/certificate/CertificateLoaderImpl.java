...
public class CertificateLoaderImpl implements CertificateLoader {
	...
	public X509Certificate load(File file) {
		try {
			...
			throw new br.gov.frameworkdemoiselle.security.certificate.CertificateException("FileNotFoundException", e);
		} catch (CertificateException e) {
			throw new br.gov.frameworkdemoiselle.security.certificate.CertificateException("CertificateException", e);
		}
	}
	...
	public X509Certificate loadFromToken(String pinNumber) {
		...
		try {
			...
			throw new br.gov.frameworkdemoiselle.security.certificate.CertificateException("", e);
		}

...
//            ASN1ObjectIdentifier objectIdentifier = new ASN1ObjectIdentifier(signaturePolicyId.getSigPolicyId());
...
//                        ASN1ObjectIdentifier oi = new ASN1ObjectIdentifier(sigPolicyQualifierInfoURL.getOID());

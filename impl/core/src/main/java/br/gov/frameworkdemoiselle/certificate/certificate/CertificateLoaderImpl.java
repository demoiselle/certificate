...
package br.gov.frameworkdemoiselle.certificate.certificate;
...
public class CertificateLoaderImpl implements CertificateLoader {
	...
	public X509Certificate load(File file) {
		try {
			...
			throw new br.gov.frameworkdemoiselle.certificate.certificate.CertificateException("FileNotFoundException", e);
		} catch (CertificateException e) {
			throw new br.gov.frameworkdemoiselle.certificate.certificate.CertificateException("CertificateException", e);
		}
	}
	...
	public X509Certificate loadFromToken(String pinNumber) {
		...
		try {
			...
			throw new br.gov.frameworkdemoiselle.certificate.certificate.CertificateException("", e);
		}

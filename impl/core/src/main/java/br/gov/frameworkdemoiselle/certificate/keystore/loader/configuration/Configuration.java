...
public class Configuration {
    ...
    private Configuration() {
        ...
        map.put("TokenOuSmartCard", winRoot.concat("/system32/ngp11v211.dll"));
        map.put("TokenOuSmartCard", winRoot.concat("/system32/aetpkss1.dll"));
        map.put("TokenOuSmartCard", winRoot.concat("/system32/gclib.dll"));
        map.put("TokenOuSmartCard", winRoot.concat("/system32/pk2priv.dll"));
        map.put("TokenOuSmartCard", winRoot.concat("/system32/w32pk2ig.dll"));
        map.put("TokenOuSmartCard", winRoot.concat("/system32/eTPkcs11.dll"));
        map.put("TokenOuSmartCard", winRoot.concat("/system32/acospkcs11.dll"));
        map.put("TokenOuSmartCard", winRoot.concat("/system32/dkck201.dll"));
        map.put("TokenOuSmartCard", winRoot.concat("/system32/dkck232.dll"));
        map.put("TokenOuSmartCard", winRoot.concat("/system32/cryptoki22.dll"));
        map.put("TokenOuSmartCard", winRoot.concat("/system32/acpkcs.dll"));
        map.put("TokenOuSmartCard", winRoot.concat("/system32/slbck.dll"));
        map.put("TokenOuSmartCard", winRoot.concat("/system32/cmP11.dll"));
        map.put("TokenOuSmartCard", winRoot.concat("/system32/WDPKCS.dll"));
        map.put("TokenOuSmartCard", winRoot.concat("/System32/Watchdata/Watchdata Brazil CSP v1.0/WDPKCS.dll"));
        map.put("TokenOuSmartCard", "/Arquivos de programas/Gemplus/GemSafe Libraries/BIN/gclib.dll");
        map.put("TokenOuSmartCard", "/Program Files/Gemplus/GemSafe Libraries/BIN/gclib.dll");
        map.put("TokenOuSmartCard", "/usr/lib/libaetpkss.so");
        map.put("TokenOuSmartCard", "/usr/lib/libgpkcs11.so");
        map.put("TokenOuSmartCard", "/usr/lib/libgpkcs11.so.2");
        // Token Verde do Serpro
        map.put("TokenOuSmartCard", "/usr/lib/libepsng_p11.so");
        map.put("TokenOuSmartCard", "/usr/lib/libepsng_p11.so.1");
        map.put("TokenOuSmartCard", "/usr/local/ngsrv/libepsng_p11.so.1");
        // Token Azul do Serpro
        map.put("TokenOuSmartCard", "/usr/lib/libeTPkcs11.so");
        map.put("TokenOuSmartCard", "/usr/lib/libeToken.so");
        map.put("TokenOuSmartCard", "/usr/lib/libeToken.so.4");
        map.put("TokenOuSmartCard", "/usr/lib/libcmP11.so");
        ...
        map.put("TokenOuSmartCard", "/usr/lib/pkcs11/opensc-pkcs11.so");
        map.put("TokenOuSmartCard", "/usr/lib/libwdpkcs.dylib");
        map.put("TokenOuSmartCard", "/usr/local/lib/libwdpkcs.dylib");
        map.put("TokenOuSmartCard", "/usr/local/ngsrv/libepsng_p11.so.1.2.2");

...
package br.gov.frameworkdemoiselle.certificate.certificate.oid;
...
public class OIDGeneric {
	 ...
	 * 
	 * @param data
	 *            -> byte array with certificate content.
	...
	public static OIDGeneric getInstance(byte[] data) throws IOException, Exception {
		...
		String className = "br.gov.serpro.security.certificate.oid.OID_" + oid.getId().replaceAll("[.]", "_");
	 ...
	 * 
	 * @param der
	 *            -> Certificate DER (sun.security.util.DerValue)
	 * @return OIDGenerico
	 * @throws IOException
	 * @throws Exception
	 */
	public static OIDGeneric getInstance(DerValue der) throws IOException, Exception {
		...
		String className = "br.gov.serpro.security.certificate.oid.OID_" + on.getOID().toString().replaceAll("[.]", "_");
